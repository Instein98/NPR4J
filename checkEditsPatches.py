...
ids_all_info_Path = Path('ids_all_info-1700.bak').resolve()
patchesDirPath = Path('edits-patches-1700').resolve()
...
d4jProjDirPath = Path('../../mutBench/dataset/d4jProj')
...
def recoverPatches(checkCorrect=True, keepPatchedJavaFile=False):
    correctPatches = []
    fixedDict = {}
    mutatorDict = {}
...
if __name__ == '__main__':
    recoverPatches(checkCorrect=True, keepPatchedJavaFile=False)